# <h1>Billboard-Hot-100-Hits - Spring Boot Application</h1>

## Overview
Billboard-Hot-100-Hits is a Spring Boot-based REST API for managing and retrieving top songs from the Billboard charts. The application interacts with a PostgreSQL database to store song details, allowing users to perform CRUD operations and filter songs based on different criteria.
